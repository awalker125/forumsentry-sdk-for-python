...
forumsentry_api.configuration.access_token = 'YOUR_ACCESS_TOKEN'

# create an instance of the API class
api_instance = forumsentry_api.PetApi()
body = forumsentry_api.Pet() # Pet | Pet object that needs to be added to the store
