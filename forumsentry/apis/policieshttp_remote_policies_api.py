...
class PolicieshttpRemotePoliciesApi(object):
    ...
    def create_or_update_policy_with_http_info(self, id, **kwargs):
        ...
        all_params = ['id', 'description', 'enabled', 'comment', 'remote_server', 'remote_port', 'proxy_policy', 'use_chunking', 'enable_ssl', 'ssl_initiation_policy', 'tcp_connection_timeout', 'tcp_read_timeout', 'use_basic_auth', 'auth_mode', 'remote_authentication', 'http_authentication_user_policy', 'process_response']
        ...
        if 'auth_mode' in params:
            form_params.append(('authMode', params['auth_mode']))
    ...
    def create_policy_with_http_info(self, name, **kwargs):
        ...
        all_params = ['name', 'description', 'enabled', 'comment', 'remote_server', 'remote_port', 'proxy_policy', 'use_chunking', 'enable_ssl', 'ssl_initiation_policy', 'tcp_connection_timeout', 'tcp_read_timeout', 'use_basic_auth', 'auth_mode', 'remote_authentication', 'http_authentication_user_policy', 'process_response']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
