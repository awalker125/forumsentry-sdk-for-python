...
class PolicieswsdlPoliciesApi(object):
    ...
    def create_or_update_policy_0_with_http_info(self, id, virtuald_directory_id, **kwargs):
        ...
        resource_path = '/policies/wsdlPolicies/{id}/virtualDirectories/{virtualdDirectoryId}'.replace('{format}', 'json')
        path_params = {}
        if 'id' in params:
            path_params['id'] = params['id']
    ...
    def create_policy_0_with_http_info(self, id, name, **kwargs):
        ...
        resource_path = '/policies/wsdlPolicies/{id}/virtualDirectories'.replace('{format}', 'json')
        path_params = {}
        if 'id' in params:
            path_params['id'] = params['id']
