...
class HtmlPoliciesApi(Api):
    '''
    Api for working with HtmlPolicies
    '''
    
    path = "policies/htmlPolicies"
    policy_type = "HtmlPolicies"
    ...
    def __init__(self, config=None):
        ...
        Constructor
        '''
        super(HtmlPoliciesApi, self).__init__(config=config)
    
    def get(self, name):
        ''' gets a HtmlPolicies
        :param name: The name of the HtmlPolicies we want to get.
        :raises requests.exceptions.HTTPError: When response code is not successful.
        :returns: A HtmlPolicies object.
        '''
    ...
    def delete(self,name):
        ''' delete a HtmlPolicies
        :param name: The name of the HtmlPolicies we want to delete.
        :raises requests.exceptions.HTTPError: When response code is not successful.
        :returns: True/False.
        '''
        target_endpoint = "{0}/{1}".format(self.path, name)
    ...
    def set(self,name, obj):
        '''
        Creates/Updates a HtmlPolicies on the forum sentry.
        :param name: The name of the HtmlPolicies we want to create/update..
        :param obj: The HtmlPolicies object to created/updated.
        :raises requests.exceptions.HTTPError: When response code is not successful.
        :returns: The HtmlPolicies object that was created/updated.
        '''        
    ...
    def get_virtual_directory(self,name,virtual_directory):
        ''' gets a virtual directory attached to a HtmlPolicies
        :param name: The name of the HtmlPolicies we want to get the virtual directory from.
    ...
    def delete_virtual_directory(self,name,virtual_directory):
        ''' delete a virtual directory attached to a HtmlPolicies
        :param name: The name of the HtmlPolicies we want to delete the virtual directory from.
    ...
    def set_virtual_directory(self,name,virtual_directory, obj):
        '''
        Creates/Updates a virtual directory attached to a HtmlPolicies on the forum sentry.
        :param name: The name of the HtmlPolicies we want to create/update..
