...
class PoliciessslTerminationPoliciesApi(object):
    ...
    def create_policy(self, key_pair, name, **kwargs):
        """
        creates a new SSL Termination Policy
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.create_policy(key_pair, name, callback=callback_function)
        ...
        if kwargs.get('callback'):
            return self.create_policy_with_http_info(key_pair, name, **kwargs)
        else:
            (data) = self.create_policy_with_http_info(key_pair, name, **kwargs)
            return data

    def create_policy_with_http_info(self, key_pair, name, **kwargs):
        """
        creates a new SSL Termination Policy
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.create_policy_with_http_info(key_pair, name, callback=callback_function)
        ...
        all_params = ['key_pair', 'name', 'acl_policy', 'associate_dn_to_user', 'authenticate_client', 'description', 'enabled_protocols', 'signer_group', 'use_user_attr_only']
        ...
        if ('key_pair' not in params) or (params['key_pair'] is None):
            raise ValueError("Missing the required parameter `key_pair` when calling `create_policy`")
        # verify the required parameter 'name' is set
        if ('name' not in params) or (params['name'] is None):
            raise ValueError("Missing the required parameter `name` when calling `create_policy`")

        resource_path = '/policies/sslTerminationPolicies'.replace('{format}', 'json')
        path_params = {}
        ...
        if 'associate_dn_to_user' in params:
            form_params.append(('associateDnToUser', params['associate_dn_to_user']))
        if 'authenticate_client' in params:
            form_params.append(('authenticateClient', params['authenticate_client']))
        ...
        if 'use_user_attr_only' in params:
            form_params.append(('useUserAttrOnly', params['use_user_attr_only']))
        ...
        return self.api_client.call_api(resource_path, 'POST',
                                            ...
                                            response_type='SslTerminationPolicy',
    ...
    def create_policy_copy(self, id, new_id, **kwargs):
        """
        creates a copy of the SSL Termination Policy
    ...
    def create_policy_copy_with_http_info(self, id, new_id, **kwargs):
        ...
        resource_path = '/policies/sslTerminationPolicies/{id}/copy'.replace('{format}', 'json')
        path_params = {}
        if 'id' in params:
    ...
    def get_policy(self, id, **kwargs):
        """
        gets the SSL Termination Policy
    ...
    def get_policy_with_http_info(self, id, **kwargs):
        ...
        resource_path = '/policies/sslTerminationPolicies/{id}'.replace('{format}', 'json')
        path_params = {}
        if 'id' in params:
            path_params['id'] = params['id']
