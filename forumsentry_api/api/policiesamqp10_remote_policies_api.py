...
class Policiesamqp10RemotePoliciesApi(object):
    ...
    def create_or_update_policy(self, id, **kwargs):  # noqa: E501
        """creates or updates the AMQP 1.0 Remote Policy  # noqa: E501
    ...
    def create_or_update_policy_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        all_params = ['id', 'credential_source', 'description', 'enabled', 'idle_timeout_millis', 'name', 'process_response', 'remote_port', 'remote_server', 'sasl_mechanism', 'ssl_policy', 'transfer_timeout_millis', 'user_policy', 'use_ssl']  # noqa: E501
        ...
        if 'credential_source' in params:
            form_params.append(('credentialSource', params['credential_source']))  # noqa: E501
        if 'description' in params:
            form_params.append(('description', params['description']))  # noqa: E501
        if 'enabled' in params:
            form_params.append(('enabled', params['enabled']))  # noqa: E501
        if 'idle_timeout_millis' in params:
            form_params.append(('idleTimeoutMillis', params['idle_timeout_millis']))  # noqa: E501
        if 'name' in params:
        ...
        if 'sasl_mechanism' in params:
            form_params.append(('saslMechanism', params['sasl_mechanism']))  # noqa: E501
        if 'ssl_policy' in params:
            form_params.append(('sslPolicy', params['ssl_policy']))  # noqa: E501
        if 'transfer_timeout_millis' in params:
            form_params.append(('transferTimeoutMillis', params['transfer_timeout_millis']))  # noqa: E501
        if 'user_policy' in params:
            form_params.append(('userPolicy', params['user_policy']))  # noqa: E501
        ...
        return self.api_client.call_api(
            '/policies/amqp10RemotePolicies/{id}', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
            ...
            response_type='Amqp10RemotePolicy',  # noqa: E501
    ...
    def create_policy(self, name, remote_port, remote_server, **kwargs):  # noqa: E501
        """creates a new AMQP 1.0 Remote Policy  # noqa: E501
    ...
    def create_policy_with_http_info(self, name, remote_port, remote_server, **kwargs):  # noqa: E501
        ...
        all_params = ['name', 'remote_port', 'remote_server', 'credential_source', 'description', 'enabled', 'idle_timeout_millis', 'process_response', 'sasl_mechanism', 'ssl_policy', 'transfer_timeout_millis', 'user_policy', 'use_ssl']  # noqa: E501
        all_params.append('async')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        return self.api_client.call_api(
            '/policies/amqp10RemotePolicies', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def create_policy_copy(self, id, new_id, **kwargs):  # noqa: E501
        """creates a copy of the AMQP 1.0 Remote Policy  # noqa: E501
    ...
    def create_policy_copy_with_http_info(self, id, new_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/policies/amqp10RemotePolicies/{id}/copy', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def export_fsg_with_http_info(self, id, password, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/policies/amqp10RemotePolicies/{id}/fsg', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_policy(self, id, **kwargs):  # noqa: E501
        """gets the AMQP 1.0 Remote Policy  # noqa: E501
    ...
    def get_policy_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/policies/amqp10RemotePolicies/{id}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_policy_list_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/policies/amqp10RemotePolicies', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def remove_policy_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/policies/amqp10RemotePolicies/{id}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def transfer_fsg_with_http_info(self, id, agent_group, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/policies/amqp10RemotePolicies/{id}/transfer', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
