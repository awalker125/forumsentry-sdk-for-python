...
class PoliciesrequestFiltersApi(object):
    ...
    def create_policy_copy_with_http_info(self, id, new_id, **kwargs):
        ...
        resource_path = '/policies/requestFilters/{id}/copy'.replace('{format}', 'json')
        path_params = {}
        if 'id' in params:
    ...
    def get_policy_list_with_http_info(self, **kwargs):
        ...
        resource_path = '/policies/requestFilters'.replace('{format}', 'json')
        path_params = {}
    ...
    def remove_policy_with_http_info(self, id, **kwargs):
        ...
        resource_path = '/policies/requestFilters/{id}'.replace('{format}', 'json')
        path_params = {}
        if 'id' in params:
            path_params['id'] = params['id']
