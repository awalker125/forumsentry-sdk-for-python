...
class Policiess3RemotePoliciesApi(object):
    """
    ...
    def create_or_update_policy(self, id, **kwargs):
        """
        creates or updates the S3 Remote Policy
    ...
    def create_or_update_policy_with_http_info(self, id, **kwargs):
        ...
        all_params = ['id', 'enabled', 'enable_ssl', 'http_authentication_user_policy', 'name', 'process_response', 'proxy_policy', 'remote_authentication', 'remote_port', 'remote_server', 'ssl_initiation_policy', 'tcp_connection_timeout', 'tcp_read_timeout', 'use_basic_auth', 'use_chunking']
        ...
        resource_path = '/policies/s3RemotePolicies/{id}'.replace('{format}', 'json')
        path_params = {}
        if 'id' in params:
        ...
        if 'enable_ssl' in params:
            form_params.append(('enableSSL', params['enable_ssl']))
        if 'http_authentication_user_policy' in params:
            form_params.append(('httpAuthenticationUserPolicy', params['http_authentication_user_policy']))
        if 'name' in params:
            form_params.append(('name', params['name']))
        if 'process_response' in params:
            form_params.append(('processResponse', params['process_response']))
        if 'proxy_policy' in params:
            form_params.append(('proxyPolicy', params['proxy_policy']))
        if 'remote_authentication' in params:
            form_params.append(('remoteAuthentication', params['remote_authentication']))
        ...
        if 'tcp_connection_timeout' in params:
            form_params.append(('tcpConnectionTimeout', params['tcp_connection_timeout']))
        if 'tcp_read_timeout' in params:
            form_params.append(('tcpReadTimeout', params['tcp_read_timeout']))
        if 'use_basic_auth' in params:
            form_params.append(('useBasicAuth', params['use_basic_auth']))
    ...
    def create_policy(self, name, remote_port, remote_server, **kwargs):
        """
        creates a new S3 Remote Policy
    ...
    def create_policy_with_http_info(self, name, remote_port, remote_server, **kwargs):
        ...
        all_params = ['name', 'remote_port', 'remote_server', 'enabled', 'enable_ssl', 'http_authentication_user_policy', 'process_response', 'proxy_policy', 'remote_authentication', 'ssl_initiation_policy', 'tcp_connection_timeout', 'tcp_read_timeout', 'use_basic_auth', 'use_chunking']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        ...
        resource_path = '/policies/s3RemotePolicies'.replace('{format}', 'json')
        path_params = {}
    ...
    def create_policy_copy(self, id, new_id, **kwargs):
        """
        creates a copy of the S3 Remote Policy
    ...
    def create_policy_copy_with_http_info(self, id, new_id, **kwargs):
        ...
        resource_path = '/policies/s3RemotePolicies/{id}/copy'.replace('{format}', 'json')
        path_params = {}
        if 'id' in params:
            path_params['id'] = params['id']
    ...
    def export_fsg_with_http_info(self, id, password, **kwargs):
        ...
        resource_path = '/policies/s3RemotePolicies/{id}/fsg'.replace('{format}', 'json')
        path_params = {}
        if 'id' in params:
            path_params['id'] = params['id']
    ...
    def transfer_fsg_with_http_info(self, id, agent_group, **kwargs):
        ...
        resource_path = '/policies/s3RemotePolicies/{id}/transfer'.replace('{format}', 'json')
        path_params = {}
        if 'id' in params:
            path_params['id'] = params['id']
