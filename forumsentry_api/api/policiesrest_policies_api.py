...
class PoliciesrestPoliciesApi(object):
    ...
    def create_fs_project_node_copy(self, id, new_id, **kwargs):
        """
        creates a copy of the REST Policy
    ...
    def create_or_update_policy_with_http_info(self, id, virtual_directory_id, **kwargs):
        ...
        resource_path = '/policies/restPolicies/{id}/virtualDirectories/{virtualDirectoryId}'.replace('{format}', 'json')
        path_params = {}
        if 'id' in params:
            path_params['id'] = params['id']
    ...
    def create_or_update_policy_0(self, id, **kwargs):
        """
        creates or updates the REST Policy
