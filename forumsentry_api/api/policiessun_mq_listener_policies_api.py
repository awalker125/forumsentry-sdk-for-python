...
class PoliciessunMqListenerPoliciesApi(object):
    """
    ...
    def create_or_update_policy(self, id, **kwargs):
        """
        creates or updates the Sun JMQ Listener Policy
    ...
    def create_or_update_policy_with_http_info(self, id, **kwargs):
        ...
        all_params = ['id', 'acl_policy', 'description', 'destination', 'enabled', 'error_template', 'field', 'host', 'ignore_jms_reply_to', 'is_password_auth', 'is_synchronous', 'is_topic', 'name', 'number_of_sessions', 'password', 'port', 'response_delivery_mode', 'ssl_policy', 'user_name', 'use_ssl']
        ...
        resource_path = '/policies/sunMqListenerPolicies/{id}'.replace('{format}', 'json')
        path_params = {}
        if 'id' in params:
        ...
        return self.api_client.call_api(resource_path, 'PUT',
                                            ...
                                            response_type='SunMqListenerPolicy',
    ...
    def create_policy(self, name, **kwargs):
        """
        creates a new Sun JMQ Listener Policy
    ...
    def create_policy_with_http_info(self, name, **kwargs):
        ...
        all_params = ['name', 'acl_policy', 'description', 'destination', 'enabled', 'error_template', 'field', 'host', 'ignore_jms_reply_to', 'is_password_auth', 'is_synchronous', 'is_topic', 'number_of_sessions', 'password', 'port', 'response_delivery_mode', 'ssl_policy', 'user_name', 'use_ssl']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        ...
        resource_path = '/policies/sunMqListenerPolicies'.replace('{format}', 'json')
        path_params = {}
    ...
    def create_policy_copy(self, id, new_id, **kwargs):
        """
        creates a copy of the Sun JMQ Listener Policy
    ...
    def create_policy_copy_with_http_info(self, id, new_id, **kwargs):
        ...
        resource_path = '/policies/sunMqListenerPolicies/{id}/copy'.replace('{format}', 'json')
        path_params = {}
        if 'id' in params:
            path_params['id'] = params['id']
    ...
    def export_fsg_with_http_info(self, id, password, **kwargs):
        ...
        resource_path = '/policies/sunMqListenerPolicies/{id}/fsg'.replace('{format}', 'json')
        path_params = {}
        if 'id' in params:
            path_params['id'] = params['id']
    ...
    def get_policy(self, id, **kwargs):
        """
        gets the Sun JMQ Listener Policy
    ...
    def transfer_fsg_with_http_info(self, id, agent_group, **kwargs):
        ...
        resource_path = '/policies/sunMqListenerPolicies/{id}/transfer'.replace('{format}', 'json')
        path_params = {}
        if 'id' in params:
            path_params['id'] = params['id']
