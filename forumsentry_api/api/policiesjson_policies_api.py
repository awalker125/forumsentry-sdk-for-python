...
class PoliciesjsonPoliciesApi(object):
    ...
    def create_fs_project_node_copy(self, id, new_id, **kwargs):
        """
        creates a copy of the JSON Policy
    ...
    def create_or_update_policy(self, id, **kwargs):
        """
        creates or updates the JSON Policy
    ...
    def create_or_update_policy_with_http_info(self, id, **kwargs):
        ...
        return self.api_client.call_api(resource_path, 'PUT',
                                            ...
                                            post_params=form_params,
                                            files=local_var_files,
                                            response_type='JsonPolicies',
                                            auth_settings=auth_settings,
                                            callback=params.get('callback'),
                                            _return_http_data_only=params.get('_return_http_data_only'))

    def create_or_update_policy_0(self, id, virtual_directory_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.create_or_update_policy_0(id, virtual_directory_id, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.create_or_update_policy_0_with_http_info(id, virtual_directory_id, **kwargs)
        else:
            (data) = self.create_or_update_policy_0_with_http_info(id, virtual_directory_id, **kwargs)
            return data

    def create_or_update_policy_0_with_http_info(self, id, virtual_directory_id, **kwargs):
        """
        creates or updates the Virtual Directory
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.create_or_update_policy_0_with_http_info(id, virtual_directory_id, callback=callback_function)
        ...
        if ('virtual_directory_id' not in params) or (params['virtual_directory_id'] is None):
            raise ValueError("Missing the required parameter `virtual_directory_id` when calling `create_or_update_policy_0`")

        resource_path = '/policies/jsonPolicies/{id}/virtualDirectories/{virtualDirectoryId}'.replace('{format}', 'json')
        path_params = {}
        if 'id' in params:
            path_params['id'] = params['id']
    ...
    def create_policy(self, id, listener_policy, name, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.create_policy(id, listener_policy, name, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.create_policy_with_http_info(id, listener_policy, name, **kwargs)
        else:
            (data) = self.create_policy_with_http_info(id, listener_policy, name, **kwargs)
            return data

    def create_policy_with_http_info(self, id, listener_policy, name, **kwargs):
        """
        creates a new Virtual Directory
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.create_policy_with_http_info(id, listener_policy, name, callback=callback_function)
        ...
        # verify the required parameter 'id' is set
        if ('id' not in params) or (params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `create_policy`")
        # verify the required parameter 'listener_policy' is set
        if ('listener_policy' not in params) or (params['listener_policy'] is None):
            raise ValueError("Missing the required parameter `listener_policy` when calling `create_policy`")
    ...
    def create_policy_0(self, listener_policy, name, **kwargs):
        """
        creates a new JSON Policy
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.create_policy_0(listener_policy, name, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.create_policy_0_with_http_info(listener_policy, name, **kwargs)
        else:
            (data) = self.create_policy_0_with_http_info(listener_policy, name, **kwargs)
            return data

    def create_policy_0_with_http_info(self, listener_policy, name, **kwargs):
        """
        creates a new JSON Policy
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.create_policy_0_with_http_info(listener_policy, name, callback=callback_function)
        ...
        all_params = ['listener_policy', 'name', 'description', 'idp_group', 'remote_path', 'remote_policy', 'request_process', 'request_process_type', 'response_process', 'response_process_type', 'virtual_path']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
    ...
    def get_policy_0(self, id, virtual_directory_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_policy_0(id, virtual_directory_id, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_policy_0_with_http_info(id, virtual_directory_id, **kwargs)
        else:
            (data) = self.get_policy_0_with_http_info(id, virtual_directory_id, **kwargs)
            return data

    def get_policy_0_with_http_info(self, id, virtual_directory_id, **kwargs):
        """
        gets the Virtual Directory
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_policy_0_with_http_info(id, virtual_directory_id, callback=callback_function)
        ...
        # verify the required parameter 'virtual_directory_id' is set
        if ('virtual_directory_id' not in params) or (params['virtual_directory_id'] is None):
            raise ValueError("Missing the required parameter `virtual_directory_id` when calling `get_policy_0`")
    ...
    def get_policy_list(self, id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_policy_list(id, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_policy_list_with_http_info(id, **kwargs)
        else:
            (data) = self.get_policy_list_with_http_info(id, **kwargs)
            return data

    def get_policy_list_with_http_info(self, id, **kwargs):
        """
        returns a list of this policyLists virtual directories
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_policy_list_with_http_info(id, callback=callback_function)
        ...
        # verify the required parameter 'id' is set
        if ('id' not in params) or (params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `get_policy_list`")
    ...
    def get_policy_list_0(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_policy_list_0(callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_policy_list_0_with_http_info(**kwargs)
        else:
            (data) = self.get_policy_list_0_with_http_info(**kwargs)
            return data

    def get_policy_list_0_with_http_info(self, **kwargs):
        """
        returns a list of policies
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_policy_list_0_with_http_info(callback=callback_function)
    ...
    def remove_policy_0(self, id, virtual_directory_id, **kwargs):
        """
        deletes the policy
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.remove_policy_0(id, virtual_directory_id, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.remove_policy_0_with_http_info(id, virtual_directory_id, **kwargs)
        else:
            (data) = self.remove_policy_0_with_http_info(id, virtual_directory_id, **kwargs)
            return data

    def remove_policy_0_with_http_info(self, id, virtual_directory_id, **kwargs):
        """
        deletes the policy
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.remove_policy_0_with_http_info(id, virtual_directory_id, callback=callback_function)
        ...
        # verify the required parameter 'virtual_directory_id' is set
        if ('virtual_directory_id' not in params) or (params['virtual_directory_id'] is None):
            raise ValueError("Missing the required parameter `virtual_directory_id` when calling `remove_policy_0`")
