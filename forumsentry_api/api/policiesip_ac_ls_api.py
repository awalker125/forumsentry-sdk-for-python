...
class PoliciesipACLsApi(object):
    """
    ...
    def create_or_update_policy(self, id, **kwargs):
        """
        creates or updates the IP ACL Policy
    ...
    def create_or_update_policy_with_http_info(self, id, **kwargs):
        ...
        all_params = ['id', 'ip_range_means_deny', 'ip_ranges', 'name']
        ...
        resource_path = '/policies/ipACLs/{id}'.replace('{format}', 'json')
        path_params = {}
        if 'id' in params:
        ...
        if 'ip_ranges' in params:
            form_params.append(('ipRanges', params['ip_ranges']))
        if 'name' in params:
    ...
    def create_policy_with_http_info(self, name, **kwargs):
        ...
        all_params = ['name', 'ip_range_means_deny', 'ip_ranges']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        ...
        resource_path = '/policies/ipACLs'.replace('{format}', 'json')
        path_params = {}
