...
class PoliciesmqListenerPoliciesApi(object):
    ...
    def create_or_update_policy(self, id, **kwargs):  # noqa: E501
        """creates or updates the MQ Listener Policy  # noqa: E501
    ...
    def create_or_update_policy_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        all_params = ['id', 'acl_policy', 'channel', 'description', 'destination', 'enabled', 'error_template', 'field', 'host', 'ignore_jms_reply_to', 'is_password_auth', 'is_synchronous', 'is_topic', 'name', 'number_of_sessions', 'password', 'port', 'qm', 'response_delivery_mode', 'ssl_cipher_spec', 'ssl_policy', 'use_jms_message', 'user_name', 'use_ssl']  # noqa: E501
        ...
        if 'qm' in params:
            form_params.append(('QM', params['qm']))  # noqa: E501
        ...
        if 'ssl_cipher_spec' in params:
            form_params.append(('SSLCipherSpec', params['ssl_cipher_spec']))  # noqa: E501
        if 'ssl_policy' in params:
            form_params.append(('sslPolicy', params['ssl_policy']))  # noqa: E501
        if 'use_jms_message' in params:
            form_params.append(('useJmsMessage', params['use_jms_message']))  # noqa: E501
        ...
        return self.api_client.call_api(
            '/policies/mqListenerPolicies/{id}', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
            ...
            response_type='MqListenerPolicy',  # noqa: E501
    ...
    def create_policy(self, name, **kwargs):  # noqa: E501
        """creates a new MQ Listener Policy  # noqa: E501
    ...
    def create_policy_with_http_info(self, name, **kwargs):  # noqa: E501
        ...
        all_params = ['name', 'acl_policy', 'channel', 'description', 'destination', 'enabled', 'error_template', 'field', 'host', 'ignore_jms_reply_to', 'is_password_auth', 'is_synchronous', 'is_topic', 'number_of_sessions', 'password', 'port', 'qm', 'response_delivery_mode', 'ssl_cipher_spec', 'ssl_policy', 'use_jms_message', 'user_name', 'use_ssl']  # noqa: E501
        all_params.append('async')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        return self.api_client.call_api(
            '/policies/mqListenerPolicies', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def create_policy_copy(self, id, new_id, **kwargs):  # noqa: E501
        """creates a copy of the MQ Listener Policy  # noqa: E501
    ...
    def create_policy_copy_with_http_info(self, id, new_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/policies/mqListenerPolicies/{id}/copy', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def export_fsg_with_http_info(self, id, password, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/policies/mqListenerPolicies/{id}/fsg', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_policy(self, id, **kwargs):  # noqa: E501
        """gets the MQ Listener Policy  # noqa: E501
    ...
    def get_policy_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/policies/mqListenerPolicies/{id}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_policy_list_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/policies/mqListenerPolicies', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def remove_policy_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/policies/mqListenerPolicies/{id}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def transfer_fsg_with_http_info(self, id, agent_group, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/policies/mqListenerPolicies/{id}/transfer', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
