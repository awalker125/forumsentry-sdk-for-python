...
class PoliciesmqListenerPoliciesApi(object):
    """
    ...
    def create_or_update_policy(self, id, **kwargs):
        """
        creates or updates the MQ Listener Policy
        ...
        :param str ssl_cipher_spec: 
        :param str ssl_policy: 
        :param bool use_jms_message: 
        :param str user_name: 
        :param bool use_ssl: 
        :return: MqListenerPolicy
    ...
    def create_or_update_policy_with_http_info(self, id, **kwargs):
        ...
        all_params = ['id', 'acl_policy', 'channel', 'description', 'destination', 'enabled', 'error_template', 'field', 'host', 'ignore_jms_reply_to', 'is_password_auth', 'is_synchronous', 'is_topic', 'name', 'number_of_sessions', 'password', 'port', 'qm', 'response_delivery_mode', 'ssl_cipher_spec', 'ssl_policy', 'use_jms_message', 'user_name', 'use_ssl']
        ...
        resource_path = '/policies/mqListenerPolicies/{id}'.replace('{format}', 'json')
        path_params = {}
        if 'id' in params:
        ...
        if 'channel' in params:
            form_params.append(('channel', params['channel']))
        if 'description' in params:
            form_params.append(('description', params['description']))
        if 'destination' in params:
            form_params.append(('destination', params['destination']))
        ...
        if 'field' in params:
            form_params.append(('field', params['field']))
        if 'host' in params:
            form_params.append(('host', params['host']))
        if 'ignore_jms_reply_to' in params:
            form_params.append(('ignoreJmsReplyTo', params['ignore_jms_reply_to']))
        if 'is_password_auth' in params:
            form_params.append(('isPasswordAuth', params['is_password_auth']))
        if 'is_synchronous' in params:
            form_params.append(('isSynchronous', params['is_synchronous']))
        if 'is_topic' in params:
            form_params.append(('isTopic', params['is_topic']))
        if 'name' in params:
            form_params.append(('name', params['name']))
        if 'number_of_sessions' in params:
            form_params.append(('numberOfSessions', params['number_of_sessions']))
        if 'password' in params:
            form_params.append(('password', params['password']))
        if 'port' in params:
            form_params.append(('port', params['port']))
        if 'qm' in params:
            form_params.append(('QM', params['qm']))
        if 'response_delivery_mode' in params:
            form_params.append(('responseDeliveryMode', params['response_delivery_mode']))
        if 'ssl_cipher_spec' in params:
            form_params.append(('SSLCipherSpec', params['ssl_cipher_spec']))
        if 'ssl_policy' in params:
            form_params.append(('sslPolicy', params['ssl_policy']))
        if 'use_jms_message' in params:
            form_params.append(('useJmsMessage', params['use_jms_message']))
        ...
        return self.api_client.call_api(resource_path, 'PUT',
                                            ...
                                            response_type='MqListenerPolicy',
    ...
    def create_policy(self, name, **kwargs):
        """
        creates a new MQ Listener Policy
    ...
    def create_policy_with_http_info(self, name, **kwargs):
        ...
        all_params = ['name', 'acl_policy', 'channel', 'description', 'destination', 'enabled', 'error_template', 'field', 'host', 'ignore_jms_reply_to', 'is_password_auth', 'is_synchronous', 'is_topic', 'number_of_sessions', 'password', 'port', 'qm', 'response_delivery_mode', 'ssl_cipher_spec', 'ssl_policy', 'use_jms_message', 'user_name', 'use_ssl']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        ...
        resource_path = '/policies/mqListenerPolicies'.replace('{format}', 'json')
        path_params = {}
    ...
    def create_policy_copy(self, id, new_id, **kwargs):
        """
        creates a copy of the MQ Listener Policy
    ...
    def create_policy_copy_with_http_info(self, id, new_id, **kwargs):
        ...
        resource_path = '/policies/mqListenerPolicies/{id}/copy'.replace('{format}', 'json')
        path_params = {}
        if 'id' in params:
            path_params['id'] = params['id']
    ...
    def export_fsg_with_http_info(self, id, password, **kwargs):
        ...
        resource_path = '/policies/mqListenerPolicies/{id}/fsg'.replace('{format}', 'json')
        path_params = {}
        if 'id' in params:
            path_params['id'] = params['id']
    ...
    def transfer_fsg_with_http_info(self, id, agent_group, **kwargs):
        ...
        resource_path = '/policies/mqListenerPolicies/{id}/transfer'.replace('{format}', 'json')
        path_params = {}
        if 'id' in params:
            path_params['id'] = params['id']
