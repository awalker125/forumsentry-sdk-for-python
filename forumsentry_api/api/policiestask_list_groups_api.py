...
class PoliciestaskListGroupsApi(object):
    ...
    def create_or_update_policy(self, id, **kwargs):
        """
        creates or updates the Task List Group
    ...
    def create_or_update_policy_with_http_info(self, id, **kwargs):
        ...
        all_params = ['id', 'description', 'name', 'task_lists']
        ...
        resource_path = '/policies/taskListGroups/{id}'.replace('{format}', 'json')
        path_params = {}
        if 'id' in params:
        ...
        if 'task_lists' in params:
            form_params.append(('taskLists', params['task_lists']))
    ...
    def create_policy_with_http_info(self, name, **kwargs):
        ...
        all_params = ['name', 'description', 'task_lists']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        ...
        resource_path = '/policies/taskListGroups'.replace('{format}', 'json')
        path_params = {}
    ...
    def create_policy_copy(self, id, new_id, **kwargs):
        """
        creates a copy of the Task List Group
    ...
    def create_policy_copy_with_http_info(self, id, new_id, **kwargs):
        ...
        resource_path = '/policies/taskListGroups/{id}/copy'.replace('{format}', 'json')
        path_params = {}
        if 'id' in params:
            path_params['id'] = params['id']
    ...
    def export_fsg_with_http_info(self, id, password, **kwargs):
        ...
        resource_path = '/policies/taskListGroups/{id}/fsg'.replace('{format}', 'json')
        path_params = {}
        if 'id' in params:
            path_params['id'] = params['id']
    ...
    def transfer_fsg_with_http_info(self, id, agent_group, **kwargs):
        ...
        resource_path = '/policies/taskListGroups/{id}/transfer'.replace('{format}', 'json')
        path_params = {}
        if 'id' in params:
            path_params['id'] = params['id']
