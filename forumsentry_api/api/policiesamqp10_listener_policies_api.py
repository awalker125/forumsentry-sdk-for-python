...
class Policiesamqp10ListenerPoliciesApi(object):
    ...
    def create_or_update_policy(self, id, **kwargs):
        """
        creates or updates the AMQP 1.0 Listener Policy
    ...
    def create_or_update_policy_with_http_info(self, id, **kwargs):
        ...
        all_params = ['id', 'acl_policy', 'description', 'enabled', 'error_template', 'interface', 'ip', 'ip_acl_policy', 'name', 'port', 'read_timeout_millis', 'sasl_mechanism', 'ssl_policy', 'use_device_ip', 'use_ssl']
        ...
        resource_path = '/policies/amqp10ListenerPolicies/{id}'.replace('{format}', 'json')
        path_params = {}
        if 'id' in params:
        ...
        return self.api_client.call_api(resource_path, 'PUT',
                                            ...
                                            response_type='Amqp10ListenerPolicy',
    ...
    def create_policy(self, name, **kwargs):
        """
        creates a new AMQP 1.0 Listener Policy
    ...
    def create_policy_with_http_info(self, name, **kwargs):
        ...
        all_params = ['name', 'acl_policy', 'description', 'enabled', 'error_template', 'interface', 'ip', 'ip_acl_policy', 'port', 'read_timeout_millis', 'sasl_mechanism', 'ssl_policy', 'use_device_ip', 'use_ssl']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        ...
        resource_path = '/policies/amqp10ListenerPolicies'.replace('{format}', 'json')
        path_params = {}
    ...
    def create_policy_copy(self, id, new_id, **kwargs):
        """
        creates a copy of the AMQP 1.0 Listener Policy
    ...
    def create_policy_copy_with_http_info(self, id, new_id, **kwargs):
        ...
        resource_path = '/policies/amqp10ListenerPolicies/{id}/copy'.replace('{format}', 'json')
        path_params = {}
        if 'id' in params:
            path_params['id'] = params['id']
    ...
    def export_fsg_with_http_info(self, id, password, **kwargs):
        ...
        resource_path = '/policies/amqp10ListenerPolicies/{id}/fsg'.replace('{format}', 'json')
        path_params = {}
        if 'id' in params:
            path_params['id'] = params['id']
    ...
    def get_policy(self, id, **kwargs):
        """
        gets the AMQP 1.0 Listener Policy
    ...
    def transfer_fsg_with_http_info(self, id, agent_group, **kwargs):
        ...
        resource_path = '/policies/amqp10ListenerPolicies/{id}/transfer'.replace('{format}', 'json')
        path_params = {}
        if 'id' in params:
            path_params['id'] = params['id']
