...
class Policiesx509CertificatesApi(object):
    """
    ...
    def get_policy_list_with_http_info(self, **kwargs):
        ...
        resource_path = '/policies/x509Certificates'.replace('{format}', 'json')
        path_params = {}
    ...
    def remove_policy_with_http_info(self, id, **kwargs):
        ...
        resource_path = '/policies/x509Certificates/{id}'.replace('{format}', 'json')
        path_params = {}
        if 'id' in params:
