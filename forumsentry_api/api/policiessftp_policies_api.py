...
class PoliciessftpPoliciesApi(object):
    ...
    def create_or_update_policy(self, id, **kwargs):
        """
        creates or updates the SFTP Policy
    ...
    def create_or_update_policy_with_http_info(self, id, **kwargs):
        ...
        all_params = ['id', 'acl_policy', 'description', 'enabled', 'error_template', 'interface', 'ip', 'name', 'port', 'read_timeout_millis', 'use_device_ip']
        ...
        resource_path = '/policies/sftpPolicies/{id}'.replace('{format}', 'json')
        path_params = {}
        if 'id' in params:
    ...
    def create_policy_with_http_info(self, name, **kwargs):
        ...
        all_params = ['name', 'acl_policy', 'description', 'enabled', 'error_template', 'interface', 'ip', 'port', 'read_timeout_millis', 'use_device_ip']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        ...
        resource_path = '/policies/sftpPolicies'.replace('{format}', 'json')
        path_params = {}
    ...
    def create_policy_copy(self, id, new_id, **kwargs):
        """
        creates a copy of the SFTP Policy
    ...
    def create_policy_copy_with_http_info(self, id, new_id, **kwargs):
        ...
        resource_path = '/policies/sftpPolicies/{id}/copy'.replace('{format}', 'json')
        path_params = {}
        if 'id' in params:
            path_params['id'] = params['id']
    ...
    def export_fsg_with_http_info(self, id, password, **kwargs):
        ...
        resource_path = '/policies/sftpPolicies/{id}/fsg'.replace('{format}', 'json')
        path_params = {}
        if 'id' in params:
            path_params['id'] = params['id']
    ...
    def transfer_fsg_with_http_info(self, id, agent_group, **kwargs):
        ...
        resource_path = '/policies/sftpPolicies/{id}/transfer'.replace('{format}', 'json')
        path_params = {}
        if 'id' in params:
            path_params['id'] = params['id']
