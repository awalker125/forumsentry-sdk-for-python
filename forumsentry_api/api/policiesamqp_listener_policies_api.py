...
class PoliciesamqpListenerPoliciesApi(object):
    ...
    def create_or_update_policy(self, id, **kwargs):
        """
        creates or updates the AMQP Listener Policy
    ...
    def create_or_update_policy_with_http_info(self, id, **kwargs):
        ...
        all_params = ['id', 'description', 'enabled', 'error_template', 'name']
        ...
        resource_path = '/policies/amqpListenerPolicies/{id}'.replace('{format}', 'json')
        path_params = {}
        if 'id' in params:
        ...
        return self.api_client.call_api(resource_path, 'PUT',
                                            ...
                                            response_type='AmqpListenerPolicy',
    ...
    def create_policy(self, name, **kwargs):
        """
        creates a new AMQP Listener Policy
    ...
    def create_policy_with_http_info(self, name, **kwargs):
        ...
        all_params = ['name', 'description', 'enabled', 'error_template']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        ...
        resource_path = '/policies/amqpListenerPolicies'.replace('{format}', 'json')
        path_params = {}
    ...
    def create_policy_copy(self, id, new_id, **kwargs):
        """
        creates a copy of the AMQP Listener Policy
    ...
    def create_policy_copy_with_http_info(self, id, new_id, **kwargs):
        ...
        resource_path = '/policies/amqpListenerPolicies/{id}/copy'.replace('{format}', 'json')
        path_params = {}
        if 'id' in params:
            path_params['id'] = params['id']
    ...
    def export_fsg_with_http_info(self, id, password, **kwargs):
        ...
        resource_path = '/policies/amqpListenerPolicies/{id}/fsg'.replace('{format}', 'json')
        path_params = {}
        if 'id' in params:
            path_params['id'] = params['id']
    ...
    def transfer_fsg_with_http_info(self, id, agent_group, **kwargs):
        ...
        resource_path = '/policies/amqpListenerPolicies/{id}/transfer'.replace('{format}', 'json')
        path_params = {}
        if 'id' in params:
            path_params['id'] = params['id']
