...
class PoliciessmtpRemotePoliciesApi(object):
    ...
    def create_or_update_policy(self, id, **kwargs):
        """
        creates or updates the SMTP Remote Policy
    ...
    def create_or_update_policy_with_http_info(self, id, **kwargs):
        ...
        all_params = ['id', 'description', 'enabled', 'name', 'remote_port', 'remote_server', 'sub_type', 'to_address']
        ...
        resource_path = '/policies/smtpRemotePolicies/{id}'.replace('{format}', 'json')
        path_params = {}
        if 'id' in params:
        ...
        if 'sub_type' in params:
            form_params.append(('subType', params['sub_type']))
        if 'to_address' in params:
            form_params.append(('toAddress', params['to_address']))
        ...
        return self.api_client.call_api(resource_path, 'PUT',
                                            ...
                                            response_type='SmtpRemotePolicy',
    ...
    def create_policy(self, name, remote_port, remote_server, **kwargs):
        """
        creates a new SMTP Remote Policy
    ...
    def create_policy_with_http_info(self, name, remote_port, remote_server, **kwargs):
        ...
        all_params = ['name', 'remote_port', 'remote_server', 'description', 'enabled', 'sub_type', 'to_address']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        ...
        resource_path = '/policies/smtpRemotePolicies'.replace('{format}', 'json')
        path_params = {}
    ...
    def create_policy_copy(self, id, new_id, **kwargs):
        """
        creates a copy of the SMTP Remote Policy
    ...
    def create_policy_copy_with_http_info(self, id, new_id, **kwargs):
        ...
        resource_path = '/policies/smtpRemotePolicies/{id}/copy'.replace('{format}', 'json')
        path_params = {}
        if 'id' in params:
            path_params['id'] = params['id']
    ...
    def export_fsg_with_http_info(self, id, password, **kwargs):
        ...
        resource_path = '/policies/smtpRemotePolicies/{id}/fsg'.replace('{format}', 'json')
        path_params = {}
        if 'id' in params:
            path_params['id'] = params['id']
    ...
    def transfer_fsg_with_http_info(self, id, agent_group, **kwargs):
        ...
        resource_path = '/policies/smtpRemotePolicies/{id}/transfer'.replace('{format}', 'json')
        path_params = {}
        if 'id' in params:
            path_params['id'] = params['id']
