...
class PoliciestibRemotePoliciesApi(object):
    ...
    def create_or_update_policy(self, id, **kwargs):
        """
        creates or updates the Tibco Remote Policy
    ...
    def create_or_update_policy_with_http_info(self, id, **kwargs):
        ...
        resource_path = '/policies/tibRemotePolicies/{id}'.replace('{format}', 'json')
        path_params = {}
        if 'id' in params:
    ...
    def create_policy(self, name, **kwargs):
        """
        creates a new Tibco Remote Policy
    ...
    def create_policy_with_http_info(self, name, **kwargs):
        ...
        resource_path = '/policies/tibRemotePolicies'.replace('{format}', 'json')
        path_params = {}
    ...
    def create_policy_copy(self, id, new_id, **kwargs):
        """
        creates a copy of the Tibco Remote Policy
    ...
    def create_policy_copy_with_http_info(self, id, new_id, **kwargs):
        ...
        resource_path = '/policies/tibRemotePolicies/{id}/copy'.replace('{format}', 'json')
        path_params = {}
        if 'id' in params:
            path_params['id'] = params['id']
    ...
    def export_fsg_with_http_info(self, id, password, **kwargs):
        ...
        resource_path = '/policies/tibRemotePolicies/{id}/fsg'.replace('{format}', 'json')
        path_params = {}
        if 'id' in params:
            path_params['id'] = params['id']
    ...
    def transfer_fsg_with_http_info(self, id, agent_group, **kwargs):
        ...
        resource_path = '/policies/tibRemotePolicies/{id}/transfer'.replace('{format}', 'json')
        path_params = {}
        if 'id' in params:
            path_params['id'] = params['id']
