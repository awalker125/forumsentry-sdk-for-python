...
class PoliciesmqRemotePoliciesApi(object):
    ...
    def create_or_update_policy(self, id, **kwargs):  # noqa: E501
        """creates or updates the MQ Remote Policy  # noqa: E501
    ...
    def create_or_update_policy_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        all_params = ['id', 'description', 'enabled', 'host', 'initial_pool_connections', 'jms_priority', 'name', 'port', 'process_response', 'propagate_reply_to', 'propagate_ttl', 'rep_allowed_message_types', 'rep_destination', 'rep_queue_temp', 'rep_topic', 'rep_use_jms_message', 'req_channel', 'req_delivery_mode', 'req_destination', 'req_field', 'req_message_type', 'req_password', 'req_qm', 'req_ssl_cipher_spec', 'req_topic', 'req_use_as_queue', 'req_use_jms_message', 'req_user_name', 'ssl_policy', 'synchronous', 'sync_timeout_millis', 'time_to_live_seconds', 'use_ssl']  # noqa: E501
    ...
    def create_policy(self, name, **kwargs):  # noqa: E501
        """creates a new MQ Remote Policy  # noqa: E501
    ...
    def create_policy_with_http_info(self, name, **kwargs):  # noqa: E501
        ...
        all_params = ['name', 'description', 'enabled', 'host', 'initial_pool_connections', 'jms_priority', 'port', 'process_response', 'propagate_reply_to', 'propagate_ttl', 'rep_allowed_message_types', 'rep_destination', 'rep_queue_temp', 'rep_topic', 'rep_use_jms_message', 'req_channel', 'req_delivery_mode', 'req_destination', 'req_field', 'req_message_type', 'req_password', 'req_qm', 'req_ssl_cipher_spec', 'req_topic', 'req_use_as_queue', 'req_use_jms_message', 'req_user_name', 'ssl_policy', 'synchronous', 'sync_timeout_millis', 'time_to_live_seconds', 'use_ssl']  # noqa: E501
        all_params.append('async')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def create_policy_copy(self, id, new_id, **kwargs):  # noqa: E501
        """creates a copy of the MQ Remote Policy  # noqa: E501
    ...
    def get_policy(self, id, **kwargs):  # noqa: E501
        """gets the MQ Remote Policy  # noqa: E501
