...
class PolicieswebLogicListenerPoliciesApi(object):
    ...
    def create_or_update_policy(self, id, **kwargs):  # noqa: E501
        """creates or updates the WebLogic Listener Policy  # noqa: E501
    ...
    def create_or_update_policy_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        all_params = ['id', 'acl_policy', 'description', 'destination', 'enabled', 'error_template', 'field', 'ignore_jms_reply_to', 'is_password_auth', 'is_synchronous', 'is_topic', 'name', 'number_of_sessions', 'password', 'port', 'response_delivery_mode', 'ssl_policy', 'user_name', 'use_ssl']  # noqa: E501
        ...
        return self.api_client.call_api(
            '/policies/webLogicListenerPolicies/{id}', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
            ...
            response_type='WebLogicListenerPolicy',  # noqa: E501
    ...
    def create_policy(self, name, **kwargs):  # noqa: E501
        """creates a new WebLogic Listener Policy  # noqa: E501
    ...
    def create_policy_with_http_info(self, name, **kwargs):  # noqa: E501
        ...
        all_params = ['name', 'acl_policy', 'description', 'destination', 'enabled', 'error_template', 'field', 'ignore_jms_reply_to', 'is_password_auth', 'is_synchronous', 'is_topic', 'number_of_sessions', 'password', 'port', 'response_delivery_mode', 'ssl_policy', 'user_name', 'use_ssl']  # noqa: E501
        all_params.append('async')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        return self.api_client.call_api(
            '/policies/webLogicListenerPolicies', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def create_policy_copy(self, id, new_id, **kwargs):  # noqa: E501
        """creates a copy of the WebLogic Listener Policy  # noqa: E501
    ...
    def create_policy_copy_with_http_info(self, id, new_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/policies/webLogicListenerPolicies/{id}/copy', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def export_fsg_with_http_info(self, id, password, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/policies/webLogicListenerPolicies/{id}/fsg', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_policy(self, id, **kwargs):  # noqa: E501
        """gets the WebLogic Listener Policy  # noqa: E501
    ...
    def get_policy_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/policies/webLogicListenerPolicies/{id}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_policy_list_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/policies/webLogicListenerPolicies', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def remove_policy_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/policies/webLogicListenerPolicies/{id}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def transfer_fsg_with_http_info(self, id, agent_group, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/policies/webLogicListenerPolicies/{id}/transfer', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
