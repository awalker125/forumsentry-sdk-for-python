...
class PoliciesxmlPoliciesApi(object):
    ...
    def create_fs_project_node_copy(self, id, new_id, **kwargs):
        """
        creates a copy of the XML Policy
    ...
    def create_or_update_policy_with_http_info(self, id, virtual_directory_id, **kwargs):
        ...
        resource_path = '/policies/xmlPolicies/{id}/virtualDirectories/{virtualDirectoryId}'.replace('{format}', 'json')
        path_params = {}
        if 'id' in params:
            path_params['id'] = params['id']
    ...
    def create_or_update_policy_0(self, id, **kwargs):
        """
        creates or updates the XML Policy
    ...
    def create_policy_0(self, name, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.create_policy_0(name, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.create_policy_0_with_http_info(name, **kwargs)
        else:
            (data) = self.create_policy_0_with_http_info(name, **kwargs)
            return data

    def create_policy_0_with_http_info(self, name, **kwargs):
        """
        creates a new XML Policy
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.create_policy_0_with_http_info(name, callback=callback_function)
