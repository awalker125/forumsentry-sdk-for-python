...
class PolicieshttpRemotePoliciesApi(object):
    ...
    def create_or_update_policy(self, id, **kwargs):
        """
        creates or updates the HTTP Remote Policy
    ...
    def create_or_update_policy_with_http_info(self, id, **kwargs):
        ...
        resource_path = '/policies/httpRemotePolicies/{id}'.replace('{format}', 'json')
        path_params = {}
        if 'id' in params:
        ...
        return self.api_client.call_api(resource_path, 'PUT',
                                            ...
                                            response_type='HttpRemotePolicy',
    ...
    def create_policy(self, name, remote_port, remote_server, **kwargs):
        """
        creates a new HTTP Remote Policy
    ...
    def create_policy_with_http_info(self, name, remote_port, remote_server, **kwargs):
        ...
        resource_path = '/policies/httpRemotePolicies'.replace('{format}', 'json')
        path_params = {}
    ...
    def create_policy_copy(self, id, new_id, **kwargs):
        """
        creates a copy of the HTTP Remote Policy
    ...
    def create_policy_copy_with_http_info(self, id, new_id, **kwargs):
        ...
        resource_path = '/policies/httpRemotePolicies/{id}/copy'.replace('{format}', 'json')
        path_params = {}
        if 'id' in params:
            path_params['id'] = params['id']
    ...
    def export_fsg_with_http_info(self, id, password, **kwargs):
        ...
        resource_path = '/policies/httpRemotePolicies/{id}/fsg'.replace('{format}', 'json')
        path_params = {}
        if 'id' in params:
            path_params['id'] = params['id']
    ...
    def transfer_fsg_with_http_info(self, id, agent_group, **kwargs):
        ...
        resource_path = '/policies/httpRemotePolicies/{id}/transfer'.replace('{format}', 'json')
        path_params = {}
        if 'id' in params:
            path_params['id'] = params['id']
