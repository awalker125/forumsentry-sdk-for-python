...
class PoliciesrestPoliciesApi(object):
    ...
    def create_fs_project_node_copy_with_http_info(self, id, name, virtual_path, remote_path, http_remote_policy, **kwargs):
        ...
        resource_path = '/policies/restPolicies/{id}/copy'.replace('{format}', 'json')
        path_params = {}
        if 'id' in params:
    ...
    def create_or_update_policy_with_http_info(self, id, **kwargs):
        ...
        resource_path = '/policies/restPolicies/{id}'.replace('{format}', 'json')
        path_params = {}
        if 'id' in params:
            path_params['id'] = params['id']
    ...
    def create_or_update_policy_0_with_http_info(self, id, virtuald_directory_id, **kwargs):
        ...
        resource_path = '/policies/restPolicies/{id}/virtualDirectories/{virtualdDirectoryId}'.replace('{format}', 'json')
        path_params = {}
        if 'id' in params:
            path_params['id'] = params['id']
    ...
    def create_policy_with_http_info(self, name, **kwargs):
        ...
        resource_path = '/policies/restPolicies'.replace('{format}', 'json')
        path_params = {}
    ...
    def create_policy_0_with_http_info(self, id, name, **kwargs):
        ...
        resource_path = '/policies/restPolicies/{id}/virtualDirectories'.replace('{format}', 'json')
        path_params = {}
        if 'id' in params:
            path_params['id'] = params['id']
    ...
    def export_fsg_with_http_info(self, id, password, **kwargs):
        ...
        resource_path = '/policies/restPolicies/{id}/fsg'.replace('{format}', 'json')
        path_params = {}
        if 'id' in params:
            path_params['id'] = params['id']
    ...
    def transfer_fsg_with_http_info(self, id, agent_group, **kwargs):
        ...
        resource_path = '/policies/restPolicies/{id}/transfer'.replace('{format}', 'json')
        path_params = {}
        if 'id' in params:
            path_params['id'] = params['id']
