...
class PolicieshttpRemotePoliciesApi(object):
    ...
    def create_or_update_policy_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        all_params = ['id', 'description', 'enabled', 'comment', 'remote_server', 'remote_port', 'proxy_policy', 'use_chunking', 'enable_ssl', 'ssl_initiation_policy', 'tcp_connection_timeout', 'tcp_read_timeout', 'use_basic_auth', 'auth_mode', 'remote_authentication', 'http_authentication_user_policy', 'process_response']  # noqa: E501
        ...
        if 'auth_mode' in params:
            form_params.append(('authMode', params['auth_mode']))  # noqa: E501
    ...
    def create_policy_with_http_info(self, name, **kwargs):  # noqa: E501
        ...
        all_params = ['name', 'description', 'enabled', 'comment', 'remote_server', 'remote_port', 'proxy_policy', 'use_chunking', 'enable_ssl', 'ssl_initiation_policy', 'tcp_connection_timeout', 'tcp_read_timeout', 'use_basic_auth', 'auth_mode', 'remote_authentication', 'http_authentication_user_policy', 'process_response']  # noqa: E501
        all_params.append('async')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
