...
class PoliciestaskListsApi(object):
    ...
    def create_or_update_policy_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        all_params = ['id', 'description', 'identity_oauth_scope']  # noqa: E501
        ...
        if 'identity_oauth_scope' in params:
            form_params.append(('identityOauthScope', params['identity_oauth_scope']))  # noqa: E501
    ...
    def create_policy_copy_with_http_info(self, id, new_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/policies/taskLists/{id}/copy', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def export_fsg_with_http_info(self, id, password, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/policies/taskLists/{id}/fsg', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def transfer_fsg_with_http_info(self, id, agent_group, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/policies/taskLists/{id}/transfer', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
