...
from forumsentry.apis.policiessftp_policies_api import PoliciessftpPoliciesApi
...
class TestPoliciessftpPoliciesApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = forumsentry.apis.policiessftp_policies_api.PoliciessftpPoliciesApi()
