...
from forumsentry.apis.policieshttp_listener_policies_api import PolicieshttpListenerPoliciesApi
...
class TestPolicieshttpListenerPoliciesApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = forumsentry.apis.policieshttp_listener_policies_api.PolicieshttpListenerPoliciesApi()
