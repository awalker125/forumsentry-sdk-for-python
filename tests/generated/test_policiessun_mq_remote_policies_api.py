...
from forumsentry.apis.policiessun_mq_remote_policies_api import PoliciessunMqRemotePoliciesApi
...
class TestPoliciessunMqRemotePoliciesApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = forumsentry.apis.policiessun_mq_remote_policies_api.PoliciessunMqRemotePoliciesApi()
