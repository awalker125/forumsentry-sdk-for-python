...
from forumsentry.apis.policiestib_listener_policies_api import PoliciestibListenerPoliciesApi
...
class TestPoliciestibListenerPoliciesApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = forumsentry.apis.policiestib_listener_policies_api.PoliciestibListenerPoliciesApi()
