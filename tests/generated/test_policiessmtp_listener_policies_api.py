...
from forumsentry.apis.policiessmtp_listener_policies_api import PoliciessmtpListenerPoliciesApi
...
class TestPoliciessmtpListenerPoliciesApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = forumsentry.apis.policiessmtp_listener_policies_api.PoliciessmtpListenerPoliciesApi()
