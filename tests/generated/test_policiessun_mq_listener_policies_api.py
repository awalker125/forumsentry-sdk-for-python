...
from forumsentry.apis.policiessun_mq_listener_policies_api import PoliciessunMqListenerPoliciesApi
...
class TestPoliciessunMqListenerPoliciesApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = forumsentry.apis.policiessun_mq_listener_policies_api.PoliciessunMqListenerPoliciesApi()
