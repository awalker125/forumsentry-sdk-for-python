...
from forumsentry.apis.policiesrest_policies_api import PoliciesrestPoliciesApi
...
class TestPoliciesrestPoliciesApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = forumsentry.apis.policiesrest_policies_api.PoliciesrestPoliciesApi()
