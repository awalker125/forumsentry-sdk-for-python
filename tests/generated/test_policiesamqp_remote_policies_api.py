...
from forumsentry.apis.policiesamqp_remote_policies_api import PoliciesamqpRemotePoliciesApi
...
class TestPoliciesamqpRemotePoliciesApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = forumsentry.apis.policiesamqp_remote_policies_api.PoliciesamqpRemotePoliciesApi()
