...
from forumsentry.apis.policiesjboss_listener_policies_api import PoliciesjbossListenerPoliciesApi
...
class TestPoliciesjbossListenerPoliciesApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = forumsentry.apis.policiesjboss_listener_policies_api.PoliciesjbossListenerPoliciesApi()
