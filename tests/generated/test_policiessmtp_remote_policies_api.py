...
from forumsentry.apis.policiessmtp_remote_policies_api import PoliciessmtpRemotePoliciesApi
...
class TestPoliciessmtpRemotePoliciesApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = forumsentry.apis.policiessmtp_remote_policies_api.PoliciessmtpRemotePoliciesApi()
