...
from forumsentry.apis.policiesactive_mq_remote_policies_api import PoliciesactiveMqRemotePoliciesApi
...
class TestPoliciesactiveMqRemotePoliciesApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = forumsentry.apis.policiesactive_mq_remote_policies_api.PoliciesactiveMqRemotePoliciesApi()
