...
from forumsentry.apis.policiesjboss_remote_policies_api import PoliciesjbossRemotePoliciesApi
...
class TestPoliciesjbossRemotePoliciesApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = forumsentry.apis.policiesjboss_remote_policies_api.PoliciesjbossRemotePoliciesApi()
