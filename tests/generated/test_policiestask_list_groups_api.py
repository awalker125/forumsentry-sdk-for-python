...
from forumsentry.apis.policiestask_list_groups_api import PoliciestaskListGroupsApi
...
class TestPoliciestaskListGroupsApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = forumsentry.apis.policiestask_list_groups_api.PoliciestaskListGroupsApi()
