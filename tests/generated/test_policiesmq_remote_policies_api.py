...
from forumsentry.apis.policiesmq_remote_policies_api import PoliciesmqRemotePoliciesApi
...
class TestPoliciesmqRemotePoliciesApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = forumsentry.apis.policiesmq_remote_policies_api.PoliciesmqRemotePoliciesApi()
