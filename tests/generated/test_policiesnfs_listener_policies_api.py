...
from forumsentry.apis.policiesnfs_listener_policies_api import PoliciesnfsListenerPoliciesApi
...
class TestPoliciesnfsListenerPoliciesApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = forumsentry.apis.policiesnfs_listener_policies_api.PoliciesnfsListenerPoliciesApi()
