...
from forumsentry.apis.policiestibems_remote_policies_api import PoliciestibemsRemotePoliciesApi
...
class TestPoliciestibemsRemotePoliciesApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = forumsentry.apis.policiestibems_remote_policies_api.PoliciestibemsRemotePoliciesApi()
