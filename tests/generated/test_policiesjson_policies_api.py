...
from forumsentry.apis.policiesjson_policies_api import PoliciesjsonPoliciesApi
...
class TestPoliciesjsonPoliciesApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = forumsentry.apis.policiesjson_policies_api.PoliciesjsonPoliciesApi()
