...
from forumsentry.apis.policieswsdl_policies_api import PolicieswsdlPoliciesApi
...
class TestPolicieswsdlPoliciesApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = forumsentry.apis.policieswsdl_policies_api.PolicieswsdlPoliciesApi()
