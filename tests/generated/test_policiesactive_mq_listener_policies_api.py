...
from forumsentry.apis.policiesactive_mq_listener_policies_api import PoliciesactiveMqListenerPoliciesApi
...
class TestPoliciesactiveMqListenerPoliciesApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = forumsentry.apis.policiesactive_mq_listener_policies_api.PoliciesactiveMqListenerPoliciesApi()
