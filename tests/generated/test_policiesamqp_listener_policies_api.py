...
from forumsentry.apis.policiesamqp_listener_policies_api import PoliciesamqpListenerPoliciesApi
...
class TestPoliciesamqpListenerPoliciesApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = forumsentry.apis.policiesamqp_listener_policies_api.PoliciesamqpListenerPoliciesApi()
