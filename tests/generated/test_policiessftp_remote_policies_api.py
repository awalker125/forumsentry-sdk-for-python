...
from forumsentry.apis.policiessftp_remote_policies_api import PoliciessftpRemotePoliciesApi
...
class TestPoliciessftpRemotePoliciesApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = forumsentry.apis.policiessftp_remote_policies_api.PoliciessftpRemotePoliciesApi()
