...
from forumsentry.apis.policiess_remote_policies_api import PoliciessRemotePoliciesApi


class TestPoliciessRemotePoliciesApi(unittest.TestCase):
    """ PoliciessRemotePoliciesApi unit test stubs """

    def setUp(self):
        self.api = forumsentry.apis.policiess_remote_policies_api.PoliciessRemotePoliciesApi()
