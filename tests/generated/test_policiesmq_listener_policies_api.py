...
from forumsentry.apis.policiesmq_listener_policies_api import PoliciesmqListenerPoliciesApi
...
class TestPoliciesmqListenerPoliciesApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = forumsentry.apis.policiesmq_listener_policies_api.PoliciesmqListenerPoliciesApi()
