...
from forumsentry.apis.policiestibems_listener_policies_api import PoliciestibemsListenerPoliciesApi
...
class TestPoliciestibemsListenerPoliciesApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = forumsentry.apis.policiestibems_listener_policies_api.PoliciestibemsListenerPoliciesApi()
