...
from forumsentry_api.api.policiessftp_policies_api import PoliciessftpPoliciesApi  # noqa: E501
from forumsentry_api.rest import ApiException


class TestPoliciessftpPoliciesApi(unittest.TestCase):
    """PoliciessftpPoliciesApi unit test stubs"""

    def setUp(self):
        self.api = forumsentry_api.api.policiessftp_policies_api.PoliciessftpPoliciesApi()  # noqa: E501
