...
from forumsentry_api.api.policiess3_remote_policies_api import Policiess3RemotePoliciesApi  # noqa: E501
from forumsentry_api.rest import ApiException


class TestPoliciess3RemotePoliciesApi(unittest.TestCase):
    """Policiess3RemotePoliciesApi unit test stubs"""

    def setUp(self):
        self.api = forumsentry_api.api.policiess3_remote_policies_api.Policiess3RemotePoliciesApi()  # noqa: E501
