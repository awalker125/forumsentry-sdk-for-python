...
from forumsentry_api.apis.policiess3_remote_policies_api import Policiess3RemotePoliciesApi
...
class TestPoliciess3RemotePoliciesApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = forumsentry_api.apis.policiess3_remote_policies_api.Policiess3RemotePoliciesApi()
