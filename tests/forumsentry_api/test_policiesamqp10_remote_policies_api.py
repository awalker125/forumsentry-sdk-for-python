...
from forumsentry_api.apis.policiesamqp10_remote_policies_api import Policiesamqp10RemotePoliciesApi
...
class TestPoliciesamqp10RemotePoliciesApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = forumsentry_api.apis.policiesamqp10_remote_policies_api.Policiesamqp10RemotePoliciesApi()
