...
from forumsentry_api.apis.configurationimport_api import ConfigurationimportApi
...
class TestConfigurationimportApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = forumsentry_api.apis.configurationimport_api.ConfigurationimportApi()
