...
from forumsentry_api.apis.policieslogging_configurations_api import PoliciesloggingConfigurationsApi
...
class TestPoliciesloggingConfigurationsApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = forumsentry_api.apis.policieslogging_configurations_api.PoliciesloggingConfigurationsApi()
