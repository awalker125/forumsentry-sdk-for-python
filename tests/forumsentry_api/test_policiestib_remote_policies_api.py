...
from forumsentry_api.apis.policiestib_remote_policies_api import PoliciestibRemotePoliciesApi
...
class TestPoliciestibRemotePoliciesApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = forumsentry_api.apis.policiestib_remote_policies_api.PoliciestibRemotePoliciesApi()
