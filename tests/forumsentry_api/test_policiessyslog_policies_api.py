...
from forumsentry_api.apis.policiessyslog_policies_api import PoliciessyslogPoliciesApi
...
class TestPoliciessyslogPoliciesApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = forumsentry_api.apis.policiessyslog_policies_api.PoliciessyslogPoliciesApi()
