...
class TestPoliciestibemsListenerPoliciesApi(unittest.TestCase):
    """ PoliciestibemsListenerPoliciesApi unit test stubs """

    def setUp(self):
        self.api = forumsentry_api.apis.policiestibems_listener_policies_api.PoliciestibemsListenerPoliciesApi()
