...
from forumsentry_api.apis.policiesamqp10_listener_policies_api import Policiesamqp10ListenerPoliciesApi
...
class TestPoliciesamqp10ListenerPoliciesApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = forumsentry_api.apis.policiesamqp10_listener_policies_api.Policiesamqp10ListenerPoliciesApi()
