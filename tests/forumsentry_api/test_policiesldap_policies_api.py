...
from forumsentry_api.apis.policiesldap_policies_api import PoliciesldapPoliciesApi


class TestPoliciesldapPoliciesApi(unittest.TestCase):
    """ PoliciesldapPoliciesApi unit test stubs """

    def setUp(self):
        self.api = forumsentry_api.apis.policiesldap_policies_api.PoliciesldapPoliciesApi()
