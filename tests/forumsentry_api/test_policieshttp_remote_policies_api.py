...
class TestPolicieshttpRemotePoliciesApi(unittest.TestCase):
    """ PolicieshttpRemotePoliciesApi unit test stubs """

    def setUp(self):
        self.api = forumsentry_api.apis.policieshttp_remote_policies_api.PolicieshttpRemotePoliciesApi()
