...
from forumsentry_api.api.policiesmq_remote_policies_api import PoliciesmqRemotePoliciesApi  # noqa: E501
from forumsentry_api.rest import ApiException


class TestPoliciesmqRemotePoliciesApi(unittest.TestCase):
    """PoliciesmqRemotePoliciesApi unit test stubs"""

    def setUp(self):
        self.api = forumsentry_api.api.policiesmq_remote_policies_api.PoliciesmqRemotePoliciesApi()  # noqa: E501
