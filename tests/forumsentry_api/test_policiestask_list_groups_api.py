...
from forumsentry_api.api.policiestask_list_groups_api import PoliciestaskListGroupsApi  # noqa: E501
from forumsentry_api.rest import ApiException


class TestPoliciestaskListGroupsApi(unittest.TestCase):
    """PoliciestaskListGroupsApi unit test stubs"""

    def setUp(self):
        self.api = forumsentry_api.api.policiestask_list_groups_api.PoliciestaskListGroupsApi()  # noqa: E501
