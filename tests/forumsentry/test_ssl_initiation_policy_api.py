...
from forumsentry import ssl_initiation_policy_api
...
class TestApi(unittest.TestCase):
    ...
    def test_ssl_initiation_policy_api_get1(self, mock_get):
        '''
        ...
        self.assertTrue(isinstance(have_state, SslInitiationPolicy))
        self.assertEqual(have_state.name, "bill")

    @mock.patch("forumsentry.api.requests.get")
    def test_ssl_initiation_policy_api_get2(self, mock_get):
        '''
    ...
    @mock.patch("forumsentry.api.requests.get")
    def test_ssl_initiation_policy_api_get3(self, mock_get):
        '''
    ...
    def test_ssl_initiation_policy_api_set1(self, mock_put):
        ...
        model.signer_group = test_name
        model.enabled_protocols = ['TLSv1.2','TLSv1.1']
        model.ignore_hostname_verification = False
        model.key_pair = test_name
         
        created = self._api.set(test_name, model)
         
        self.assertIsInstance(created, SslInitiationPolicy)
    ...
    def test_ssl_initiation_policy_api_delete1(self, mock_delete):
        '''
            Tests when requests gets a successful response from forum
        '''
        test_name = sys._getframe().f_code.co_name
    ...
    @mock.patch("forumsentry.api.requests.delete")
    def test_ssl_initiation_policy_api_delete2(self, mock_delete):
        '''
            Tests when requests gets a 404 response from forum
        '''
        test_name = sys._getframe().f_code.co_name
    ...
    @mock.patch("forumsentry.api.requests.delete")
    def test_ssl_initiation_policy_api_delete3(self, mock_delete):
        '''
